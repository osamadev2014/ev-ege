...
export function SiteFooter() {
  return (
    <footer className="bg-[#111827] text-white">
      <div className="mx-auto max-w-screen-xl px-6 lg:px-10 pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                aria-label="LinkedIn"
                className="text-white/40 hover:text-[#2563EB] transition-colors"
              >
                <LinkedinIcon />
              </a>
              <a
          ...
          <div>
            <p className="text-[#2563EB] text-xs font-semibold uppercase tracking-widest mb-5">روابط</p>
          ...
          <div>
            <p className="text-[#2563EB] text-xs font-semibold uppercase tracking-widest mb-5">تواصل معنا</p>
            ...
            <div className="mt-8 flex flex-col gap-4 text-sm text-white/40">
              <div>
                <p className="text-white/60 font-medium mb-1">{siteContact.city}</p>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-screen-xl px-6 lg:px-10 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
